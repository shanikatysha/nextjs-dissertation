  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [{
        ...
        - emotions: array of 4-6 key emotional patterns (e.g., "ambivalence", "cultural anxiety")
        - conflicts: array of 3-5 internal/external conflicts
        - overallTone: a single sentence describing the story's emotional tone
        - colors: array of 3 colors associated with the story's emotional tone (e.g., "coral pink", "electric blue")
